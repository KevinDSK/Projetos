<?php
    ...
    $sql = "SELECT * FROM Academia WHERE idAcademia=".$_GET['idAltera'];
...
<html>
    <head>
        ...
        <title>Alterando Academia</title>
                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Alterar Academia</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="listaAcademia.php">Lista de Academias</a>
                                        </li>
                                        <li class="breadcrumb-item active" aria-current="page">Alterar Academia</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemAlteraAcademia'])){
                                    echo $_SESSION['mensagemAlteraAcademia'];
                                    unset($_SESSION['mensagemAlteraAcademia']);
                                }
                            ?>
                            
                            <div class="card">
                                <form class="form-horizontal" action="../../controller/sistemaAdm.php?op=2&idAltera=<?php echo $_GET['idAltera'] ?>" method="post">
                                    <div class="card-body">
                                        <h4 class="card-title">Alterar Academia</h4>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3>Deseja realmente excluir <?php echo $academia->nomeAcademia ?> ?</h3>
                        <form align="center" action="../../controller/sistemaAdm.php?op=3&idExclui=<?php echo $_GET['idAltera']?>" method="post" class="form-horizontal">
