                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Detalhes da Notícia</h4>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Detalhes da Notícia</h4>
                                    <div align="right">
                                        <a href="alteraNoticia.php?idAltera=<?php echo $_GET['idNoticia'] ?>" class="btn btn-info">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form align="center" action="../../controller/sistemaAdm.php?op=9&idExclui=<?php echo $_GET['idNoticia']?>" method="post" class="form-horizontal">
