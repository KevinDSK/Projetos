<?php
    ...
    $sql = "SELECT * FROM Noticia WHERE idNoticia=".$_GET['idAltera'];

    $smt = $con->query($sql);
    
    if(($noticia = $smt->fetch_object()) == true){
?>
                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Alterar Notícia</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Alterando Notícia</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemAlteraNoticia'])){
                                    echo $_SESSION['mensagemAlteraNoticia'];
                                    unset($_SESSION['mensagemAlteraNoticia']);
                                }
                            ?>
                            
                            <div class="card">
                                <form class="form-horizontal" action="../../controller/sistemaAdm.php?op=8&idAltera=<?php echo $_GET['idAltera'] ?>" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <h4 class="card-title">Alterar Notícia</h4>
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right control-label col-form-label">Título da Notícia :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Título" name="titulo" required value="<?php echo $noticia->titulo ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="5" name="descricao"><?php echo $noticia->descricao ?></textarea>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3>Deseja realmente excluir <?php echo $noticia->titulo ?> ?</h3>
                        <form align="center" action="../../controller/sistemaAdm.php?op=9&idExclui=<?php echo $_GET['idAltera']?>" method="post" class="form-horizontal">
                            <button type="submit" class="btn btn-danger">Sim</button>
                            <button data-dismiss="modal" class="btn btn-success">Não</button>
                        </form>
                    </div>
                </div>
            </div>
