    ...
    <head>
        ...
        <script>
			<?php
                ...
                $sql = "SELECT * FROM Delegacia LIMIT 1";
                
                $smt = $con->query($sql);
                $delegacia = $smt->fetch_object();
                
                if(isset($_POST['idDelegacia'])){
                    $sql = "SELECT * FROM Delegacia WHERE idDelegacia=".$_POST['idDelegacia'];
                ...
                $evento = new Evento();
                echo $evento->exibirEvento($delegacia->idDelegacia);
            ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xlg-3">
                            <a href="cadCampeonato.php" class="card card-hover">
                                <div class="box bg-success text-center">
                                    <h1 class="font-light text-white">
                                        <i class="far fa-clipboard"></i>
                                    </h1>
                                    <h6 class="text-white">Cadastrar Evento</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Calendário de Campeonatos</h4>
                                    <form class="form-horizontal" action="calendario.php" method="post">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-sm-3 m-t-15 text-right control-label col-form-label">Escolha a Delegacia :</label>
                                                <div class="col-md-6">
