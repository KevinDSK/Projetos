                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Cadastrar Delegacia</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Cadastrar Delegacia</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemCadDelegacia'])){
                                    echo $_SESSION['mensagemCadDelegacia'];
                                    unset($_SESSION['mensagemCadDelegacia']);
                                }
                            ?>
                            
                            <div class="card">
                                <form class="form-horizontal" action="../../controller/sistemaAdm.php?op=4" method="post">
                                    <div class="card-body">
                                        <h4 class="card-title">Cadastrar Delegacia</h4>
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nome da Delegacia :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Ex: 1 Delegacia - Capital" name="regiao" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="lname" placeholder="Ex: 1" name="numero" required>
                                            </div>
                                        </div>
                                    </div>
