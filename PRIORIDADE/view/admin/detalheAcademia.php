                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Detalhes da Academia</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Detalhes da Academia</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Detalhes da Academia</h4>
                                    <div align="right">
                                        <a href="alteraAcademia.php?idAltera=<?php echo $_GET['id'] ?>" class="btn btn-info">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            echo $academia->detalheAcademia($_GET['id']);
                                        ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form align="center" action="../../controller/sistemaAdm.php?op=3&idExclui=<?php echo $_GET['id']?>" method="post" class="form-horizontal">
