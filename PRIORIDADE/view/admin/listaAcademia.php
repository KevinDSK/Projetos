                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Lista de Academias</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Lista de Academias</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xlg-3">
                            <a href="cadAcademia.php" class="card card-hover">
                                <div class="box bg-success text-center">
                                    <h1 class="font-light text-white">
                                        <i class="far fa-clipboard"></i>
                                    </h1>
                                    <h6 class="text-white">Cadastrar Academia</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                ...
                                if(isset($_SESSION['mensagemExcluiAcademia'])){
                                    echo $_SESSION['mensagemExcluiAcademia'];
                                    unset($_SESSION['mensagemExcluiAcademia']);
                                }
                            ?>
