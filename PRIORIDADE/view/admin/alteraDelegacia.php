<?php
    ...
    if(($delegacia = $smt->fetch_object()) == true){
?>
...
<html>
    <head>
        ...
        <title>Alterando Delegacia</title>
                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Alterar Delegacia</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="listaDelegacia.php">Lista de Delegacias</a>
                                        </li>
                                        <li class="breadcrumb-item active" aria-current="page">Alterando Delegacia</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xlg-3">
                            <a href="listaDelegacia.php" class="card card-hover">
                                <div class="box bg-info text-center">
                                    <h1 class="font-light text-white">
                                        <i class="far fa-clipboard"></i>
                                    </h1>
                                    <h6 class="text-white">Delegacia</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <div class="card">
                                <form class="form-horizontal" action="../../controller/sistemaAdm.php?op=5&idAltera=<?php echo $_GET['idAltera'] ?>" method="post">
                                    <div class="card-body">
                                        <h4 class="card-title">Altera Delegacia</h4>
                                        <div class="form-group row">
                                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nome da Delegacia :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Ex: 1 Delegacia - Capital" name="regiao" required value="<?php echo $delegacia->regiao;?>">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group row">
                                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Número da Delegacia :</label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="lname" placeholder="Ex: 1" name="numero" required value="<?php echo $delegacia->numero;?>">
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3>Deseja realmente excluir <?php echo $delegacia->regiao ?> ?</h3>
                        <form align="center" action="../../controller/sistemaAdm.php?op=6&idExclui=<?php echo $_GET['idAltera']?>" method="post" class="form-horizontal">
...
<?php
        ...
        header("Location: listaDelegacia.php");
    }
?>