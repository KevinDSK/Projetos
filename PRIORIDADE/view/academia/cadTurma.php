                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Cadastrar Turma</h4>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemCadTurma'])){
                                    echo $_SESSION['mensagemCadTurma'];
                                    unset($_SESSION['mensagemCadTurma']);
                                }
                            ?>
                            
                            <div class="card">
                                <form class="form-horizontal" action="../../controller/sistemaAcademia.php?op=1" method="post">
                                    <div class="card-body">
                                        <h4 class="card-title">Cadastrar Turma</h4>
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right control-label col-form-label">Turno e hora da turma :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" placeholder="Ex: Noite 18:30" name="nomeTurma" required>
                                            </div>
                                        </div>
