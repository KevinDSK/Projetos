                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Lista de Turma</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Lista de Turma</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xlg-3">
                            <a href="cadTurma.php" class="card card-hover">
                                <div class="box bg-success text-center">
                                    <h1 class="font-light text-white">
                                        <i class="fas fa-plus"></i>
                                    </h1>
                                    <h6 class="text-white">Cadastrar Turma</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemAlteraTurma'])){
                                    echo $_SESSION['mensagemAlteraTurma'];
                                    unset($_SESSION['mensagemAlteraTurma']);
                                }
                            
                                if(isset($_SESSION['mensagemExcluiTurma'])){
                                    echo $_SESSION['mensagemExcluiTurma'];
                                    unset($_SESSION['mensagemExcluiTurma']);
                                }
                            ?>
                            
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Lista de Turma</h4>
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            echo $turma->listaTurma($_SESSION['idAcademia']);
                                        ?>
