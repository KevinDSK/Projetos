                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="p-t-30">
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="index.php" aria-expanded="false">
                        ...
                        <div class="col-md">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div align="right">
                                        <a href="alteraAtleta.php?idAltera=<?php echo $_GET['id'] ?>" class="btn btn-info">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            echo $aluno->detalheAtleta($_GET['id']);
                                        ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3>Deseja realmente excluir o(a) atleta ?</h3>
                        <form align="center" action="../../controller/sistemaAcademia.php?op=6&idExclui=<?php echo $_GET['id']?>" method="post" class="form-horizontal">
