                        ...
                        <div class="col-md">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                        if(isset($_SESSION['mensagemAlteraPerfil'])){
                                            echo $_SESSION['mensagemAlteraPerfil'];
                                            unset($_SESSION['mensagemAlteraPerfil']);
                                        }
                                    ?>
                                    
                                    <div align="right">
                                        <a href="alteraPerfil.php" class="btn btn-info">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            ...
                                            echo $academia->detalheAcademia($_SESSION['idAcademia']);
                                        ?>
                                    </div>
                                </div>
                            </div>
