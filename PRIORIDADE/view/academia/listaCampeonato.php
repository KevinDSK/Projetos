...
<html>
    <head>
        ...
        <title>Relaçao de Atletas</title>
        
        <!-- CSS -->
        <link rel="stylesheet" type="text/css" href="../css/multicheck.css">
        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Atletas que irão participar</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Atletas que irão participar</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        if(isset($_SESSION['relato'])){
                            echo $_SESSION['relato'];
                            unset($_SESSION['relato']);
                        }
                    ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <?php
                                    ...
                                    echo $campeonato->exibirLista($_POST['id']);
                                ?>
