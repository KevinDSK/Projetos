...
<html>
    <head>
        ...
        <title>Chamada de Atletas</title>
                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Chamada de Atletas</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Chamada de Atletas</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemCadChamada'])){
                                    echo $_SESSION['mensagemCadChamada'];
                                    unset($_SESSION['mensagemCadChamada']);
                                }
                            ?>
                                ...
                                <form class="form-horizontal" action="chamada.php" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 text-right control-label col-form-label">Escolha a turma para fazer a chamada :</label>
                                            <div class="col-sm-9">
