                 ...
                 <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">Lista de Faltas</h4>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Lista de Faltas</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xlg-3">
                            <a href="cadChamada.php" class="card card-hover">
                                <div class="box bg-success text-center">
                                    <h1 class="font-light text-white">
                                        <i class="fas fa-clipboard-check"></i>
                                    </h1>
                                    <h6 class="text-white">Fazer Chamada</h6>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <?php
                                if(isset($_SESSION['mensagemAlteraChamada'])){
                                    echo $_SESSION['mensagemAlteraChamada'];
                                    unset($_SESSION['mensagemAlteraChamada']);
                                }
                            
                                if(isset($_SESSION['mensagemExcluiChamada'])){
                                    echo $_SESSION['mensagemExcluiChamada'];
                                    unset($_SESSION['mensagemExcluiChamada']);
                                }
                            ?>
                            
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Lista de Faltas</h4>
